<!-- ========== HEADER ========== -->
<header
    class="sticky top-0 inset-x-0 bg-white border-b border-gray-200 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
    <nav
                ...
                <div
                    ...
                    @foreach ($menu->menuItems as $item)
                        ...
                        @if (empty($item->children) || $item->children->isEmpty())
                            <a class="p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 hs-scrollspy-active:bg-gray-100 active"
                                href="{{ $item->url }}">
                        ...
                        @else
                            <div
                                ...
                                <button type="button"
                                    class="hs-dropdown-toggle w-full p-2 flex items-center text-sm text-gray-800 hover:bg-gray-100 rounded-lg focus:outline-none focus:bg-gray-100 hs-scrollspy-active:bg-gray-100"
                                ...
                                <div class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 relative w-full md:w-52 hidden z-10 top-full ps-7 md:ps-0 md:bg-white md:rounded-lg md:shadow-md before:absolute before:-top-4 before:start-0 before:w-full before:h-5 md:after:hidden after:absolute after:top-1 after:start-[18px] after:w-0.5 after:h-[calc(100%-0.25rem)] after:bg-gray-100"
                                    ...
                                    <div class="py-1 md:px-1 space-y-0.5">
                                        @foreach ($item->children as $child)
                                            <a class="py-2 px-3 flex items-center text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100 hs-scrollspy-active:bg-gray-100"
                                                href="{{ $child->url }}">
                                                {{ $child->title }}
                                            </a>
                                        @endforeach
